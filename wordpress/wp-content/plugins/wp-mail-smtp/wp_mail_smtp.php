...
define( 'WPMS_SSL', '465' ); // Possible values '', 'ssl', 'tls' - note TLS is not STARTTLS.
define( 'WPMS_SMTP_AUTH', true ); // True turns it on, false turns it off.
define( 'WPMS_SMTP_USER', 'pratikpratik119@gmail.com' ); // SMTP authentication username, only used if WPMS_SMTP_AUTH is true.
define( 'WPMS_SMTP_PASS', '84849090' ); // SMTP authentication password, only used if WPMS_SMTP_AUTH is true.
